import Work from "../../public/png/work.png";
import Work1 from "../../public/png/fireCradpic.png";
import Work2 from "../../public/png/workk.png";
      ...
      <div className="grid grid-cols-3 gap-6 mt-16 container mx-auto">
        ...
        <div className="bg-[#4ddd93af] rounded-lg p-2">
          ...
          <p className="text-white text-[18px] font-light text-center ">
            Electric work encompasses various tasks related to the installation,
            maintenance, and repair of electrical systems wiring andelectrical
            installation
          </p>
          <Link to="/electrical">
          <div className="flex justify-center items-center cursor-pointer mt-2 w-[90px] p-2 round-class mx-auto bg-[#2fb999]">
            <svg
