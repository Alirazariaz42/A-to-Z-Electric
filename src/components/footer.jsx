        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-2 container mx-auto gap-2 p-4">
          <div className="col-span-2 mx-auto">
            ...
            <div className="flex justify-start gap-4 mt-3">
              ...
              <div className="flex justify-start gap-2">
                <img src={Linked} alt="" className="cursor-pointer w-[24px] h-[24px]" />
                <img src={Instagram} alt="" className="cursor-pointer w-[24px] h-[24px] " />
                <img src={Facebook} alt="" className="cursor-pointer w-[24px] h-[24px]" />
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 mt-6">
            ...
            <ul className="text-white mt-4">
              ...
              <li className="mt-1 hover:underline font-medium font-Nunito ">
                <a href="/meter">Meter Installation</a>
              </li>
            </ul>
          </div>
          <div className="col-span-1 mt-6">
